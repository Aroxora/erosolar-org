...
ENV_API="Variables={DEEPSEEK_API_KEY=$DEEPSEEK_API_KEY,TAVILY_API_KEY=$TAVILY_API_KEY,DEEPSEEK_MODEL=${DEEPSEEK_MODEL:-deepseek-v4-pro},XAI_API_KEY=${XAI_API_KEY:-},XAI_MODEL=${XAI_MODEL:-grok-4.3},GITHUB_TOKEN=${GITHUB_TOKEN:-},GITHUB_USER=${GITHUB_USER:-Aroxora},SEARCH_PROVIDER=${SEARCH_PROVIDER:-tavily},SEARXNG_URL=${SEARXNG_URL:-},FIREBASE_PROJECT_ID=$FIREBASE_PROJECT_ID,ALLOW_ORIGIN=$ALLOW_ORIGIN}"
