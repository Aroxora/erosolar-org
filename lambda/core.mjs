...
- Writes sourced AI-economics / infrastructure analysis (the public "Field notes" on erosolar.org): the search build-vs-buy trade-off, the $200-club-vs-China pricing gap, and the 2026 compute-and-capital story — circular hyperscaler financing (~$725B capex), the Apple–Google Siri deal, and SpaceX/xAI's ~$1.25T merger + orbital-data-center bet — always marking verified figures vs estimates.
