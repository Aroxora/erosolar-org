...
- Writes sourced AI-economics / infrastructure analysis (the public "Field notes" on erosolar.org): the search build-vs-buy trade-off, the $200-club-vs-China pricing gap, the 2026 compute-and-capital story (circular hyperscaler financing ~$725B capex, the Apple–Google Siri deal, SpaceX/xAI's ~$1.25T merger + orbital-data-center bet), and a valuation/geopolitics piece arguing Musk's $1T+ empire is richly priced and partly protection-dependent — Tesla ~350x earnings while BYD outsells it behind a 100%+ US EV tariff wall; SpaceX's reusable-launch moat is real but its ~$1.77T IPO mark prices in permanence (analysts: ~$600–900B); ~80% of Musk's net worth rides that one mark; tariffs + chip export controls read as symptoms of a contingent lead, not strength. Always marks verified figures vs estimates.
